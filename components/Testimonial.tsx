...
export const Testimonial: React.FC = () => {
  return (
    <section className="py-32">
       <div className="max-w-[1440px] mx-auto px-6 md:px-16 grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-11 md:pl-10">
             <FadeIn direction="right">
               <blockquote className="font-sans font-semibold text-3xl md:text-4xl text-primary leading-tight mb-12">
               ...
               <div className="flex items-center gap-4">
                  <img 
                    ...
                    alt="Alexis Bowen" 
                    className="w-12 h-12 rounded-lg object-cover border border-[#FFFFFF20]"
                  />
                  <div>
                     <div className="text-primary font-medium text-base">Alexis Bowen</div>
                     <div className="text-tertiary text-sm">Co-Founder of Elsewhere | SF 40 under 40</div>
                  </div>
               </div>
             </FadeIn>
          </div>
